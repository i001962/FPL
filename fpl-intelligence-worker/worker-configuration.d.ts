/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b98df955b4e232310be5541a0669149b)
// Runtime types generated with workerd@1.20260804.1 2026-08-10 nodejs_compat
interface __BaseEnv_Env {
	FPL_API_BASE: "https://fantasy.premierleague.com/api";
	FPL_CACHE_TTL_SECONDS: "120";
	PAYMENT_RECEIPTS: DurableObjectNamespace<import("./src/worker").PaymentReceipt>;
	ACCESS_PASSES: DurableObjectNamespace<import("./src/worker").AccessPassStore>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "PaymentReceipt" | "AccessPassStore";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FPL_API_BASE" | "FPL_CACHE_TTL_SECONDS">> {}
}
